...
cls_test_datasets=()
cls_valid_datasets=()
gen_test_datasets=("go" "java" "javascript" "php" "pubmed" "python" "reddit" "roc_ending_generation" "roc_story_generation" "ruby")
gen_valid_datasets=()
...
gen=True
split="test"
for ds in "${gen_valid_datasets[*]}" "${cls_test_datasets[*]}" "${cls_valid_datasets[*]}" "${gen_test_datasets[*]}" "wikiauto"; do
