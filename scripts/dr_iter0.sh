...
for train_set in "train" "debug"; do
  ...
  for dataset in "${datasets[@]}"; do
    ...
    generate_dense_embeddings_py_output_path="$PWD/exps/$exp_name/data/iter0/${dataset}_dpr_index"
    ...
    python DPR/generate_dense_embeddings.py \
       ...
       hydra.run.dir="$PWD/exps/$exp_name/dr/iter0/logs"
    fi

    echo -e "\n\n-------dense retriever-------\n\n"
    dr_output_path="$PWD/exps/$exp_name/data/iter0/dr_data_${dataset}_${train_set}"
