...
for train_set in "train" "debug"; do
  ...
  for dataset in "${datasets[@]}"; do
    ...
    input_dr_file="$PWD/exps/$exp_name/data/iter0/dr_data_${dataset}_${train_set}"
    out_dep_file="$PWD/exps/$exp_name/data/iter0/score_dep_file_${dataset}_${train_set}"
    output_file="$PWD/exps/$exp_name/data/iter0/dr_converted_${dataset}_${train_set}"
    ...
    echo -e "\n\n-------score ${dataset}-------\n\n"
    scorer_py_output_path="$PWD/exps/$exp_name/data/iter0/${dataset}_scoredqa.json"
    ...
    echo -e "\n\n-------merge ${dataset}-------\n\n"
    merge_out_path="$PWD/exps/$exp_name/data/iter0/${dataset}_scoredqa_merged.json"
