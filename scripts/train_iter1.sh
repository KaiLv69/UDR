...
train_dense_encoder_py_output_path="$PWD/exps/$exp_name/iter1/model_ckpt"
echo -e "\n\n-train dense encoder-\n\n"
...
python DPR/train_dense_encoder.py \
     ...
     datasets.agnews_dataset.file="${PWD}/exps/$exp_name/data/iter0/agnews_scoredqa_merged.json" \
     datasets.amazon_dataset.file="${PWD}/exps/$exp_name/data/iter0/amazon_scoredqa_merged.json" \
     datasets.break_dataset.file="${PWD}/exps/$exp_name/data/iter0/break_scoredqa_merged.json" \
     datasets.cnndailymail_dataset.file="${PWD}/exps/$exp_name/data/iter0/cnndailymail_scoredqa_merged.json" \
     datasets.cola_dataset.file="${PWD}/exps/$exp_name/data/iter0/cola_scoredqa_merged.json" \
     datasets.common_gen_dataset.file="${PWD}/exps/$exp_name/data/iter0/common_gen_scoredqa_merged.json" \
     datasets.copa_dataset.file="${PWD}/exps/$exp_name/data/iter0/copa_scoredqa_merged.json" \
     datasets.cosmos_qa_dataset.file="${PWD}/exps/$exp_name/data/iter0/cosmos_qa_scoredqa_merged.json" \
     datasets.cr_dataset.file="${PWD}/exps/$exp_name/data/iter0/cr_scoredqa_merged.json" \
     datasets.cs_explan_dataset.file="${PWD}/exps/$exp_name/data/iter0/cs_explan_scoredqa_merged.json" \
     datasets.cs_valid_dataset.file="${PWD}/exps/$exp_name/data/iter0/cs_valid_scoredqa_merged.json" \
     datasets.dart_dataset.file="${PWD}/exps/$exp_name/data/iter0/dart_scoredqa_merged.json" \
     datasets.dbpedia_dataset.file="${PWD}/exps/$exp_name/data/iter0/dbpedia_scoredqa_merged.json" \
     datasets.e2e_dataset.file="${PWD}/exps/$exp_name/data/iter0/e2e_scoredqa_merged.json" \
     datasets.go_dataset.file="${PWD}/exps/$exp_name/data/iter0/go_scoredqa_merged.json" \
     datasets.java_dataset.file="${PWD}/exps/$exp_name/data/iter0/java_scoredqa_merged.json" \
     datasets.mnli_dataset.file="${PWD}/exps/$exp_name/data/iter0/mnli_scoredqa_merged.json" \
     datasets.mr_dataset.file="${PWD}/exps/$exp_name/data/iter0/mr_scoredqa_merged.json" \
     datasets.mtop_dataset.file="${PWD}/exps/$exp_name/data/iter0/mtop_scoredqa_merged.json" \
     datasets.php_dataset.file="${PWD}/exps/$exp_name/data/iter0/php_scoredqa_merged.json" \
     datasets.pubmed_dataset.file="${PWD}/exps/$exp_name/data/iter0/pubmed_scoredqa_merged.json" \
     datasets.python_dataset.file="${PWD}/exps/$exp_name/data/iter0/python_scoredqa_merged.json" \
     datasets.reddit_dataset.file="${PWD}/exps/$exp_name/data/iter0/reddit_scoredqa_merged.json" \
     datasets.roc_ending_generation_dataset.file="${PWD}/exps/$exp_name/data/iter0/roc_ending_generation_scoredqa_merged.json" \
     datasets.roc_story_generation_dataset.file="${PWD}/exps/$exp_name/data/iter0/roc_story_generation_scoredqa_merged.json" \
     datasets.rte_dataset.file="${PWD}/exps/$exp_name/data/iter0/rte_scoredqa_merged.json" \
     datasets.smcalflow_dataset.file="${PWD}/exps/$exp_name/data/iter0/smcalflow_scoredqa_merged.json" \
     datasets.snli_dataset.file="${PWD}/exps/$exp_name/data/iter0/snli_scoredqa_merged.json" \
     datasets.sst2_dataset.file="${PWD}/exps/$exp_name/data/iter0/sst2_scoredqa_merged.json" \
     datasets.sst5_dataset.file="${PWD}/exps/$exp_name/data/iter0/sst5_scoredqa_merged.json" \
     datasets.subj_dataset.file="${PWD}/exps/$exp_name/data/iter0/subj_scoredqa_merged.json" \
     datasets.trec_dataset.file="${PWD}/exps/$exp_name/data/iter0/trec_scoredqa_merged.json" \
     datasets.wikiauto_dataset.file="${PWD}/exps/$exp_name/data/iter0/wikiauto_scoredqa_merged.json" \
     datasets.yahoo_dataset.file="${PWD}/exps/$exp_name/data/iter0/yahoo_scoredqa_merged.json" \
     datasets.yelp_full_dataset.file="${PWD}/exps/$exp_name/data/iter0/yelp_full_scoredqa_merged.json" \
