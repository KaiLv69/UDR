...
cls_valid_datasets=("qnli" "rte" "cosmos_qa" "mnli")
...
cls_test_datasets=("tweet_sentiment_extraction")
cls_valid_datasets=()
gen_test_datasets=("ruby")
gen_valid_datasets=()
...
gen=True
split="test"
for ds in "${cls_valid_datasets[*]}" "${cls_test_datasets[*]}" "${gen_valid_datasets[*]}" "${gen_test_datasets[*]}" "wikiauto"; do
