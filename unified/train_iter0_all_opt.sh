...
train_dense_encoder_py_output_path="$PWD/exps/$exp_name/model_ckpt_iter0_all_opt"
echo -e "\n\n-train dense encoder-\n\n"
...
python DPR/train_dense_encoder.py \
     ...
     datasets.break_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/break/break_train_scoredqa_merged_all.json" \
     datasets.cnndailymail_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/cnndailymail/cnndailymail_debug_scoredqa_merged_all.json" \
     datasets.cola_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/cola/cola_train_scoredqa_merged.json" \
     datasets.common_gen_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/common_gen/common_gen_train_scoredqa_merged_all.json" \
     ...
     datasets.dart_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/dart/dart_train_scoredqa_merged_all.json" \
     ...
     datasets.e2e_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/e2e/e2e_train_scoredqa_merged_all.json" \
     datasets.go_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/go/go_debug_scoredqa_merged_all.json" \
     datasets.java_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/java/java_debug_scoredqa_merged_all.json" \
     datasets.javascript_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/javascript/javascript_train_scoredqa_merged_all.json" \
     ...
     datasets.mtop_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/mtop/mtop_train_scoredqa_merged_all.json" \
     datasets.php_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/php/php_debug_scoredqa_merged_all.json" \
     datasets.pubmed_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/pubmed/pubmed_train_scoredqa_merged_all.json" \
     datasets.python_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/python/python_debug_scoredqa_merged_all.json" \
     datasets.qnli_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/qnli/qnli_train_scoredqa_merged.json" \
     datasets.reddit_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/reddit/reddit_train_scoredqa_merged_all.json" \
     datasets.roc_ending_generation_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/roc_ending_generation/roc_ending_generation_train_scoredqa_merged_all.json" \
     datasets.roc_story_generation_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/roc_story_generation/roc_story_generation_train_scoredqa_merged_all.json" \
     datasets.rte_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/rte/rte_train_scoredqa_merged.json" \
     datasets.smcalflow_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/smcalflow/smcalflow_debug_scoredqa_merged_dedup_all.json" \
     ...
     datasets.wikiauto_dataset.file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/wikiauto/wikiauto_debug_scoredqa_merged_all.json" \
