    ...
    def forward(self):
        ...
        with BufferedJsonWriter(f"{self.output_file}tmp_{self.accelerator.device}.bin") as buffer:
            for i, entry in enumerate(dataloader):
                ...
                self.data_list += entry.max_prompts.tolist()
                # print(entry.max_prompts)
                # if entry.max_prompts.item() == 0:
                #     continue
                # with torch.no_grad():
                ...
                #         buffer.write(mdata)
        with open("/remote-home/klv/exps/rtv_icl/v4/exps/bm25_kp20k_es_1020_1/data/max_prompts.txt", "w") as f:
