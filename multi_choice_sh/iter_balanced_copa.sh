...
multi_test=True
iter_test=True
exp_name="rk_iter_balanced_copa_1217_bert_15+2*10"
gen=False
...
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v6/exps/epr_balanced_copa_1217_bert/data/balanced_copa_scored_qa.json"
echo -e "\n\n-score-\n\n"
