...
multi_test=True
iter_test=True
exp_name="rk_iter_arc_easy_1216_bert_30+2*10"
gen=False
dataset="arc_easy"
method="iter"
test_split=("test")
...
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v6/exps/epr_arc_easy_1216_bert/data/arc_easy_scored_qa.json"
echo -e "\n\n-score-\n\n"
