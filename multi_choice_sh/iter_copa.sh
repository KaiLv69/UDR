...
multi_test=True
iter_test=True
exp_name="rk_iter_copa_1217_bert_80+2*20"
gen=False
dataset="copa"
method="iter"
test_split=("test")
train_set="train"
multi_epoch=(29 14 79)
iter_base=(0 20)
iter_epoch=(4 9 14 19)
...
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v6/exps/epr_copa_1217_bert/data/copa_scored_qa.json"
echo -e "\n\n-score-\n\n"
