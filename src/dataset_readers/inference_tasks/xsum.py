...
def set_length(example, idx,**kwargs):
    ...
    question_prefix = ""
    answer_prefix = "TL;DR: "
    q_field = question_prefix + example['document']
    a_field = answer_prefix + example['summary']
...
class XSumInferenceTask:
    ...
    def get_fields(self, entry):
        ...
        answer = entry['summary'] if "summary" in entry else entry['answers'][0]
