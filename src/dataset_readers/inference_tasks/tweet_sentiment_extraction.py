...
def set_length(example, idx,**kwargs):
    ...
    a_field = get_one_prompt('tweet_sentiment_extraction', 1, example['label'])
...
class TweetSentimentExtractionInferenceTask:
    ...
    def __init__(self, prompt_file, tokenizer, ds_size=None):
        ...
        self.prompts = get_test_labels(self.prompts, 'tweet_sentiment_extraction', 1)
