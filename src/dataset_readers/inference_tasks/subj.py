...
def set_length(example, idx,**kwargs):
    ...
    a_field = get_one_prompt('subj', kwargs['template_idx'], example['label'])
...
class SubjInferenceTask:
    name = "subj"

    def __init__(self, prompt_file, tokenizer, ds_size=None, template_idx=2):
        print(template_idx)
