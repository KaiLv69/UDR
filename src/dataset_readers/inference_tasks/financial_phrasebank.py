...
def set_length(example, idx,**kwargs):
    ...
    a_field = get_one_prompt('financial_phrasebank', 1, example['label'])
...
class FinancialPhrasebankInferenceTask:
    ...
    def __init__(self, prompt_file, tokenizer, ds_size=None):
        ...
        self.prompts = get_test_labels(self.prompts, 'financial_phrasebank', 1)
