...
class TrecScorerTask:
    ...
    def __init__(self, example_file, ds_size=None) -> None:
        if os.path.exists("/remote-home/klv/exps/rtv_icl/data"):
            dataset = load_from_disk("/remote-home/klv/exps/rtv_icl/data/trec")
        else:
    ...
    def get_fields(self, entry, index=-1):
        ...
        decomposition = get_one_prompt('trec', 3, entry['label'])
        test_decomposition = get_one_prompt('trec', 3, entry['test_label'])
