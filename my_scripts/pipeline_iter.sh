...
inference=True
train=False
main_process_port=23221
num_prompts=8
bm25_train=False
iter_train=False
multi_test=False
iter_test=True
exp_name="rk_iter_trec_1207_bert_80+2*20"
gen=False
dataset="trec"
method="iter"
test_split=("test")
...
#find_bm25_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v5/exps/epr_iwslt_1123_bert/data/bm25_iwslt_a_debug.json"
#echo -e "\n\n-find_bm25-\n\n"
...
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v5/exps/epr_iwslt_1123_bert/data/iwslt_scored_qa.json"
#scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v5/exps/epr_xsum_1124_bert/data/xsum_scored_qa.json"
#scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v5/exps/epr_spider_1125_bert/data/spider_scored_qa.json"
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v5/exps/epr_iwslt_en_fr_1123_bert/data/iwslt_en_fr_scored_qa.json"
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v5/exps/epr_iwslt_en_de_1123_bert/data/iwslt_en_de_scored_qa.json"
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v5/exps/epr_e2e_train_q_1128_bert/data/e2e_scored_qa.json"
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v5/exps/epr_pubmed_1204_bert/data/pubmed_scored_qa.json"
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/v6/exps/epr_trec_1207_bert/data/trec_scored_qa.json"
echo -e "\n\n-score-\n\n"
...
#    in_scored_file="/remote-home/share/xnli/tmp_2022_925/mtop_scoredqa.json"
  else
...
if [ ! -f "$PWD/exps/$exp_name/data/epr_result_prediction_${dataset}_${split}_${i}_${j}" ] && [ $inference = True ]
then
CUDA_VISIBLE_DEVICES=$cvd \
TOKENIZERS_PARALLELISM=false \
accelerate launch --num_processes $num_gpus --main_process_port ${main_process_port} --multi_gpu\
     ...
     gen="${gen}" \
    num_prompts=${num_prompts} \
     output_file="$PWD/exps/$exp_name/data/epr_result_prediction_${dataset}_${split}_${i}_${j}" \
     batch_size=20 \
     max_length=1950 \
     hydra.run.dir="$PWD/exps/$exp_name/logs"
fi
