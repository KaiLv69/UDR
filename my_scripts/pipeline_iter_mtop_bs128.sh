...
inference=True
train=True
main_process_port=23201
num_prompts=-1
bm25_train=False
iter_train=False
multi_test=True
iter_test=True
exp_name="rk_iter_mtop_1218_bert_30+2*10_bs128"
gen=True
dataset="mtop"
method="iter"
test_split=("test")
...
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/scored_data/mtop/mtop_scored_qa.json"
echo -e "\n\n-score-\n\n"
