...
multi_test=True
iter_test=True
exp_name="rk_iter_smcalflow_dedup_1218_bert_60+2*20"
gen=True
dataset="smcalflow"
method="iter"
...
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/scored_data/smcalflow/smcalflow_dedup_scored_qa.json"
echo -e "\n\n-score-\n\n"
