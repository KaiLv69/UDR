...
cvd=2,3
num_gpus=2
exp_name="rk_mrpc_0110_upr_2"
dataset="mrpc"
main_process_port=23198
num_prompts=8
train=True
fp16=True
gradient_checkpointing=False

ckpt="/nvme/xnli/lk_code/exps/rtv_icl/v7/exps/unified_bs128_acc4_rk4_0108/model_ckpt/dpr_biencoder.6_11527"
...
scorer_py_output_path="/nvme/xnli/lk_code/exps/rtv_icl/scored_data/mrpc/mrpc_scored_qa.json"
...
--exp_name ${exp_name} --iter_num ${setup_type} --epoch_num 29 --method upr \
