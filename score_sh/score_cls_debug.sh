...
sc_path="/nvme/xnli/lk_code/exps/rtv_icl/scored_data_iter0/${dataset}"
...
in_scored_file="/nvme/xnli/lk_code/exps/rtv_icl/scored_data/${dataset}/${dataset}_scored_qa.json"
